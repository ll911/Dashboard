    ...
    engineList: [
      {
        ...
        iconType: 'local',
        iconPath: 'https://start.llou.app/img/icons/bing.svg'
      },
      {
        name: 'Bing-EN',
        link: 'https://cn.bing.com/search?ensearch=1&q=',
        iconType: 'local',
        iconPath: 'https://start.llou.app/img/icons/bing-en.svg'
      },
      {
        name: '百度',
        link: 'https://www.baidu.com/s?wd=',
        iconType: 'local',
        iconPath: 'https://start.llou.app/img/icons/baidu.svg'
      },
      {
        name: '有道词典',
        link: 'http://dict.youdao.com/w/',
        iconType: 'local',
        iconPath: 'https://start.llou.app/img/icons/youdao.svg'
      }
    ],
    backupEngineList: [
      {
        ...
        iconType: 'local',
        iconPath: 'https://start.llou.app/img/icons/google.svg'
      },
      {
        name: '搜狗',
        link: 'https://www.sogou.com/tx?query=',
        iconType: 'local',
        iconPath: 'https://start.llou.app/img/icons/sougou.svg'
      },
      {
        name: 'Bilibili',
        link: 'https://search.bilibili.com/all?keyword=',
        iconType: 'local',
        iconPath: 'https://start.llou.app/img/icons/bilibili.svg'
      },
      {
        name: '淘宝',
        link: 'https://s.taobao.com/search?q=',
        iconType: 'local',
        iconPath: 'https://start.llou.app/img/icons/taobao.svg'
      }
    ],
    showTabTips: true,
    jumpType: 1,
